...
nameAliases =  {'datetime': 'DateTime',
                ...
                'waterflow': 'WaterFlowEqu1',
                'waterflow1': 'WaterFlowEqu1',
                'waterflow2': 'WaterFlowEqu2',
                'waterflow3': 'WaterFlowEqu3',
                'waterflow4': 'WaterFlowEqu4',
                'waterflowequ1': 'WaterFlowEqu1',
                'waterflowequ2': 'WaterFlowEqu2',
                'waterflowequ3': 'WaterFlowEqu3',
                'waterflowequ4': 'WaterFlowEqu4',
...
temy4dbNames=['Date', 'Time', 'DateUTC', 'TimeUTC', 'latitude', 'longitude', 'speed', 'course', 'solar_altitude', 'solar-azimuth',
       ...
       'fluo_nx_red', 'fluo_nx_green', 'fluo_nx_blue', 'fluo_kfa_red', 'fluo_kfa_green', 'fluo_kfa_blue', 
       'water_flow_1', 'water_flow_2', 'water_flow_3', 'water_flow_4',
       'temperature_ds_1', 'temperature_ds_2', 'temperature_ds_3', 'temperature_ds_4', 'temperature_ds_5', 'temperature_ds_6', 'temperature_ds_7', 'comment',
      ]
