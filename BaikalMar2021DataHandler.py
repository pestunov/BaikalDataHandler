...
import sys
my_path = 'D:\\1_Projects\\1_PythonData'
if my_path not in sys.path:
    sys.path.append(my_path)
import scifunc
import mytools
from mysecure import DB_BAIKAL_LOC_PASS, DB_BAIKAL_SER_PASS
...
tableName = "86_mar2021"
SQL_PARAM_DICT = {'host': '192.168.3.49',
                  'user': 'local',
                  'password': DB_BAIKAL_SER_PASS,
                  'db': 'baikal',
                  'port': '3306'}
SQL_PARAM_DICT_LOC = {'host': 'localhost',
                      'user': 'root',
                      'password': DB_BAIKAL_LOC_PASS,
                      'db': 'baikal_origin',
                      'port': '3306'}
